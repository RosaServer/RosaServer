...
typedef bool (*itemAddBillFunc)(int itemID, int zero, int amount);
extern itemAddBillFunc itemAddBill;
typedef void (*itemRemoveBillFunc)(int itemID, int amount);
extern itemRemoveBillFunc itemRemoveBill;
typedef int (*itemGetBillValueFunc)(int itemID);
extern itemGetBillValueFunc itemGetBillValue;
